...
SOURCES += src/activemasternode.cpp \
           ...
           src/Darksend.cpp \
           src/fargocash-cli.cpp \
           src/fargocash-tx.cpp \
           src/fargocash.cpp \
           src/db.cpp \
           ...
           src/qt/fargocash.cpp \
           src/qt/fargocashstrings.cpp \
...
RESOURCES += src/qt/fargocash.qrc src/qt/fargocash_locale.qrc

TRANSLATIONS += src/qt/locale/fargocash_bg.ts \
                src/qt/locale/fargocash_de.ts \
                src/qt/locale/fargocash_en.ts \
                src/qt/locale/fargocash_es.ts \
                src/qt/locale/fargocash_fi.ts \
                src/qt/locale/fargocash_fr.ts \
                src/qt/locale/fargocash_it.ts \
                src/qt/locale/fargocash_ja.ts \
                src/qt/locale/fargocash_pl.ts \
                src/qt/locale/fargocash_pt.ts \
                src/qt/locale/fargocash_ru.ts \
                src/qt/locale/fargocash_sk.ts \
                src/qt/locale/fargocash_sv.ts \
                src/qt/locale/fargocash_vi.ts \
                src/qt/locale/fargocash_zh_CN.ts \
                src/qt/locale/fargocash_zh_TW.ts
