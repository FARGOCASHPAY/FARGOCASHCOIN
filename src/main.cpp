...
#if defined(NDEBUG)
#error "Fargocash cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Fargocash Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	if (nHeight == 0) return 900000000 * COIN;
...
{
    RenameThread("fargocash-scriptch");
