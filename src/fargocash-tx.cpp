...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Fargocash Core fargocash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  fargocash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded fargocash transaction") + "\n" +
                               "  fargocash-tx [options] -create [commands]   " + _("Create hex-encoded fargocash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded fargocash transaction
