...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Fargocash Core"),
     ...
     * override -datadir in the fargocash.conf file in the default data directory
     * (to be consistent with fargocashd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
