...
/** Utility functions used by the FRGS Qt UI.
 */
namespace GUIUtil
{
...
// Render FRGS addresses in monospace font
...
// Parse "fargocash:" URI into recipient object, return true on successful parsing
