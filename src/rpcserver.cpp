...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Fargocash server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Fargocash server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* FRGS features */
        {"fargocash", "masternode", &masternode, true, true, false},
        {"fargocash", "masternodelist", &masternodelist, true, true, false},
        {"fargocash", "mnbudget", &mnbudget, true, true, false},
        {"fargocash", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"fargocash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"fargocash", "mnsync", &mnsync, true, true, false},
        {"fargocash", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"fargocash", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use fargocashd, or the -server option to fargocash-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               "It is recommended you use the following random password:\n"
                                               "rpcuser=fargocashrpc\n"
                                               "rpcpassword=%s\n"
                                               "(you do not need to remember this password)\n"
                                               "The username and password MUST NOT be the same.\n"
                                               "If the file does not exist, create it with owner-readable-only file permissions.\n"
                                               "It is also recommended to set alertnotify so you are notified of problems;\n"
                                               "for example: alertnotify=echo %%s | mail -s \"Fargocash Alert\" admin@foo.com\n"),
...
{
    return "> fargocash-cli " + methodname + " " + args + "\n";
}
